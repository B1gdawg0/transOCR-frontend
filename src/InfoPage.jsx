    ...
    return (
        <div className="font-poppins max-w-screen overflow-hidden">
            ...
            <ScrollReveal delay={0.7}>
                <div className="flex w-screen h-screen justify-center items-center  text-black " id="first-section">
            ...
            {/* Members Section */}
            <ScrollReveal delay={0.4}>
                <div className="h-screen flex flex-col items-center justify-center" id="member-section">
                    ...
                    <ScrollAnimation animateIn="animate__slideInRight" animateOut="animate_slideOutLeft" duration={1.5}>
                        <div className="flex flex-wrap justify-center gap-10">
                            {[
                                ...
                                <div key={index} className="flex flex-col items-center max-w-[300px] rounded-2xl bg-gray-800 shadow-lg border-2 border-black">
